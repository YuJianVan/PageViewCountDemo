...
public class Result<T> implements Serializable {
    ...
    public static <T> Result<T> failure() {
        return failure(ResultCode.RC500.getMessage());
    }
    ...
    public static <T> Result<T> failure(T data){
        return failure(ResultCode.RC500.getMessage(),data);
    }
    ...
    public static <T> Result<T> failure(String message, T data) {
        return failure(ResultCode.RC500.getCode(), message, data);
    }
    ...
    public static <T> Result<T> failure(int code, String message) {
        return failure(ResultCode.RC500.getCode(), message, null);
    }
    ...
    public static <T> Result<T> decide(boolean b) {
        return decide(b, ResultCode.RC200.getMessage(), ResultCode.RC500.getMessage());
    }
